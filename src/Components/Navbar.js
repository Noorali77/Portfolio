...
function Navbar(){
    return(
        ...
        <div className="container">
          <Link className="navbar-brand"  to='/' > <span className='nav-noor'>Noor</span> Ali</Link>
          ...
          <div className="collapse navbar-collapse" id="navbarResponsive">
            <ul className="navbar-nav ms-auto">
              ...
              <li className="nav-item mx-0 mx-lg-1"><Link className="nav-link py-3 px-0 px-lg-3 rounded" to='/skills'>Skills</Link></li>
              <li className="nav-item mx-0 mx-lg-1"><Link className="nav-link py-3 px-0 px-lg-3 rounded" to="/experience">Experience</Link></li>
